...
class NetworkSimulator:
    ...
    def plot_network(self):
        ...
        # Show plot
        plt.savefig(f'deployment_{self.dist_type}_{self.width}_{self.num_users}_{self.num_ap}_{self.prct_cl}_{self.u_sample}.pdf',
                    dpi=300)
    ...
    def plot_combined_network(self, wireless_graph, backbone_graph):
        ...
        ax.legend()
        plt.savefig(f'combined_network__{self.dist_type}_{self.width}_{self.num_users}_{self.num_ap}_{self.prct_cl}_{self.u_sample}.pdf',
                    dpi=300)
    ...
    def plot_task_request_distribution(self):
        ...
        plt.tight_layout()
        plt.savefig(f'task_distribution__{self.dist_type}_{self.width}_{self.num_users}_{self.num_ap}_{self.prct_cl}_{self.u_sample}.pdf',
                    dpi=300)
...
class NetworkSimulatorRunner:
    def __init__(self, csv_file='sim.csv'):
    ...
    def calculate_access_point_range(self, w, n):
        ...
        if user_density < 1000:
            ap_range = (10 * area_sq_km, 25 * area_sq_km)  # Low density
        elif 1000 <= user_density < 10000:
            ap_range = (50 * area_sq_km, 300 * area_sq_km)  # Moderate density
        else:
    ...
    def run_simulation(self, w, n, m, p, u_sample, dist_type):
        ...
        # Run the simulation
        simulator.run_simulation(dist_type=dist_type)
    ...
    def start(self):
        ...
        for idx, params in enumerate(self.parameters):
            ...
            try:
                ...
                self.run_simulation(w, n, m, p, u_sample, dist_type)
